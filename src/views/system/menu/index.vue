    ...
    <el-dialog :title="title" v-model="open" width="680px" append-to-body>
      <el-form ref="menuRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="21">
            <el-form-item label="英文名称" prop="menuEnName">
              <el-input v-model="form.menuEnName" placeholder="请输入菜单英文名称" />
            </el-form-item>
          </el-col>
...
<script setup name="Menu">
  ...
  const data = reactive({
    ...
    rules: {
      ...
      menuEnName: [{ required: true, message: '菜单英文名称不能为空', trigger: 'blur' }],
